...
import { Camera, ShieldCheck, ShoppingBag, Gavel, DollarSign, Tag, TrendingUp, Store } from "lucide-react";
            ...
            <div className="absolute top-16 left-6 md:left-12 flex flex-col md:flex-row items-end gap-6 w-full pr-12">
                ...
                <div className="flex-1 pb-2 min-w-0">
                    <div className="flex flex-wrap items-center gap-3 mb-2">
                        <h1 className="font-display text-3xl md:text-5xl font-black uppercase tracking-tighter truncate">
                    ...
                    <p className="text-sm md:text-base font-medium opacity-70 max-w-xl line-clamp-2">
