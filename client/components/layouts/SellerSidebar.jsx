...
const items = [
  { emoji: "🏠", label: "Dashboard", color: "var(--electric)", textColor: "#fff", href: "/seller/dashboard" },
  { emoji: "📦", label: "Products", color: "var(--acid)", textColor: "var(--ink)", href: "/seller/products" },
  { emoji: "🛒", label: "Orders", color: "var(--sunset)", textColor: "#fff", href: "/seller/orders" },
  { emoji: "👤", label: "Profile", color: "var(--hotpink)", textColor: "#fff", href: "/profile" },
];
    ...
    <>
      ...
      >
        <div className="flex h-20 w-full items-center gap-3 border-b-[3px] border-[var(--ink)] px-4">
          <Link href="/dashboard" className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border-[3px] border-[var(--ink)] bg-[var(--sunset)] font-display text-xl font-black text-white shadow-[3px_3px_0_0_var(--ink)] transition-all hover:-rotate-6 hover:shadow-[5px_5px_0_0_var(--ink)]">
            SE
          </Link>
          <AnimatePresence>
            {open && (
